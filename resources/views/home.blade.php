...
<div
    ...
    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
        ...
        @if(\Illuminate\Support\Facades\Auth::check())
            ...
            <br>
        @else
            <a href="http://hrpro.local:8000/oauth/authorize?app_key=key_123456" class="text-sm text-gray-700 dark:text-gray-500 underline" style="color: #e2e8f0">Log in</a>
                ...
                <div class="p-6">
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            ...
                            Whether you are new to the framewdoghrk or have previous experience with Laravel, we recommend
                            reading all of the gdocumentation sfrom beginning to end.
                        </div>
                    </div>
                </div>
